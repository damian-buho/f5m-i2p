...
Дякуємо, що користуєтеся **F5M / I2P**!
...
- [Задачі на GitHub](https://github.com/damian-buho/f5m-i2p/issues)
...
4. **Середовище** — операційна система, версія F5M / I2P, версія середовища виконання.
...
Платна підтримка для F5M / I2P доступна:
